...
| Claim corrections (documentation, no new data) | [`readme_layer3_caveat/`](readme_layer3_caveat/), [`cross_system_claim_surface/`](cross_system_claim_surface/) | Analysis | Closed — two claim-surface corrections. Specs only, no experiment; kept for the audit trail |
