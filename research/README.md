...
| Does kill spacing affect accumulated damage? (corrected measurement) | [`kill_spacing_corrected/`](kill_spacing_corrected/) | Confirmatory (pre-registered) | **In progress** — re-runs #9's question with the damage lag (median 14.1s) and sampling rate corrected; supersedes the archived `experiment/qdrant-kill-spacing` |
